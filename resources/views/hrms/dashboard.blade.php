    ...
    <div class="topbar-left">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-link">
                <a href="/dashboard">{{ trans('main.home') }}</a>
            </li>
...
<section id="content" class="table-layout animated fadeIn">
    ...
    <div class="chute chute-center">
                    ...
                    <div class="panel-body">
                        <div class="row pv10">
                            ...
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"><a href="{{route('employee-manager')}}"> {{ trans('main.employee_manager') }}</a></h3>
                ...
                <div class="panel panel-tile">
                    <div class="panel-body">
                        <div class="row pv10">
                            ...
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"> <a href="{{route('total-leave-list')}}"> {{ trans('main.leave_manager') }} </a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-tile">
                    <div class="panel-body">
                        <div class="row pv10">
                            ...
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"> <a href="{{route('asset-listing')}}"> {{ trans('main.asset_manager') }}  </a></h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="{{ URL::asset('assets/img/pages/dollar.jpg') }}"
                                                            class="img-responsive mauto" style="height: 100px; width: 100px;" alt=""/></div>
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"> <a href="{{route('expense-list')}}"> {{ trans('main.expense_manager') }} </a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="{{ URL::asset('assets/img/pages/clipart5.png') }}"
                                                            class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"><a href="{{route('attendance-manager')}}"> {{ trans('main.attendance_manager') }} </a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="{{ URL::asset('assets/img/pages/clipart0.png') }}"
                                                            class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"><a href="{{route('my-leave-list')}}"> {{ trans('main.leaves_manager') }} </a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="{{ URL::asset('assets/img/pages/clipart6.png') }}"
                                                            class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"><a href="{{route('hr-policy')}}"> {{ trans('main.hr_policeis') }} </a></h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if($events)
            <div class="col-md-12">
                <h3 class="mb10 mr5 notification" data-note-style="primary" style="color: darkturquoise">{{ trans('main.expense_manager') }}Latest &nbsp; Events </h3>
