            ...
            <div class="topbar-left">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-link">
                            <a href=""> {{ trans('main.awars') }} </a>
                        </li>
                        <li class="breadcrumb-current-item"> {{ trans('main.add_awards') }} </li>
                    </ol>
            </div>
        </header>
        <!-- -------------- Content -------------- -->
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                    <span class="panel-title hidden-xs"> {{ trans('main.add_award') }} </span>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"> {{ trans('main.award') }} </label>
                                            <div class="col-md-6">
                                                    <input type="text" name="name" id="input002" class="select2-single form-control" placeholder="{{ trans('main.award') }}" required>
                                            </div>
                                        </div>
