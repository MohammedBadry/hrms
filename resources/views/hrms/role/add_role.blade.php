...
<div class="content">
    ...
    <header id="topbar" class="alt">
        <div class="topbar-left">
            @if(\Route::getFacadeRoot()->current()->uri() == LaravelLocalization::getCurrentLocale().'/edit-role/{id}')
               <ol class="breadcrumb">
                ...
                @else
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-current-item"> {{ trans('main.add_role') }} </li>
                    </ol>
                @endif
        </div>
    </header>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            @if(\Route::getFacadeRoot()->current()->uri() == LaravelLocalization::getCurrentLocale().'/edit-role/{id}')
                                <span class="panel-title hidden-xs"> {{ trans('main.edit') }} {{ trans('main.role') }} </span>
                                @else
                                   <span class="panel-title hidden-xs"> {{ trans('main.add_role') }} </span>
                               @endif
                        </div>
                                ...
                                <div class="panel-body p25 pb10">
                                    ...
                                    @endif
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"> {{ trans('main.role') }} </label>
                                            <div class="col-md-6">
                                                @if(\Route::getFacadeRoot()->current()->uri() == LaravelLocalization::getCurrentLocale().'/edit-role/{id}')
                                                ...
                                                @else
                                                    <input type="text" name="name" id="input002" class="select2-single form-control" placeholder="{{ trans('main.role') }}" required>
                                                @endif
                                            </div>
                                        </div>
